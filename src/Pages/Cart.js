                ...
                <div className='container p-5'>
                    <div>
                        ...
                        <div className='d-flex align-items-center'>
                            ...
                            className=' py-2 bg-dark text-white text-decoration-none 
                            rounded px-4' style={{cursor:"pointer"}}>Select on Map <img className='ms-2' src={Loc} alt=""/></a>
                        </div>
                        <div>
                            ...
                            <div className='w-100 text-end mt-4 '>
                                <a className=' bg-dark text-white w-100 text-decoration-none rounded' style={{ padding: "10px 100px ", cursor:"pointer" }}> Order</a>
                            </div>
                        </div>
